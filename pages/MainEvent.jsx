          ...
          <section className='main-event h-full'>
            <div className=''>
              <img
                src='/main-event/fish-hero-right.png'
                alt=''
                className='hidden lg:block absolute -translate-x-1/3 rotate'
              />
              <h1 className='text-center font-secondary md:text-[42px] font-semibold text-white pt-[140px]'>
                In the spirit of seeking an advantageous journey, we challenge
                you to take the call!
              </h1>
              <p className='text-center pt-[49px] md:p-main-event text-white font-secondary w-4/5'>
