        ...
        <main className={`overflow-x-hidden`}>
          <section className="hero-main-event h-screen w-screen">
            ...
            <div className="flex flex-col justify-center items-center h-screen w-screen">
              <h2 className="text-main-event-2 font-primary md:text-4xl text-2xl">MABA CUP 2022</h2>
              <h1 className="text-main-event text-center font-primary md:text-9xl text-5xl">Main Event</h1>
            </div>
          </section>
          {/* End Hero */}
          ...
          <section className="main-event h-full">
            <div className="">
              ...
              />
              <h1 className="text-center font-secondary md:text-[42px] font-semibold text-white md:pt-[140px] pt-[50px] mx-auto w-11/12">In the spirit of seeking an advantageous journey, we challenge you to take the call!</h1>
              <p className="text-center pt-[49px] md:p-main-event text-white mx-auto w-2/3 font-secondary">MABACUP 2022 are looking for the finest freshman year student to attest their potential
              ...
              <div className="box-main-event w-11/12 lg:w-10/12 md:h-[350px] lg:h-[320px] mt-[100px] md:mt-[242px]">
                ...
                <div className="md:hidden py-10 flex flex-col gap-y-20 items-center">
                  ...
                  <div className="flex justify-center items-center gap-x-2 relative z-[10] -translate-y-2 w-5/6">
                    <p className="text-white font-secondary text-center w-11/12">15 Oktober 2022</p>
                    <img src="/page-staff/mutiara.png" alt="" className="w-12 mx-auto"/>
                    <p className="text-white font-secondary text-center w-11/12">Open Registration</p>
                  </div>
                  <div className="flex justify-center items-center gap-x-2 relative z-[10] -translate-y-2 w-5/6">
                    <p className="text-white font-secondary text-center w-11/12">22 Oktober 2022 - 5 November 2022</p>
                    <img src="/page-staff/mutiara.png" alt="" className="w-12 mx-auto"/>
                    <p className="text-white font-secondary text-center w-11/12">Submit Karya <br /> (Essay & Poster dan Stand Up)</p>
                  </div>
                  <div className="flex justify-center items-center gap-x-2 relative z-[10] -translate-y-2 w-5/6">
                    <p className="text-white font-secondary text-center w-11/12">22 Oktober 2022 - 5 November 2022</p>
                    <img src="/page-staff/mutiara.png" alt="" className="w-12 mx-auto"/>
                    <p className="text-white font-secondary text-center w-11/12">Close Registration</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="pt-[100px] md:pt-[200px]">
              ...
              <div className="flex justify-center items-center gap-x-2 md:gap-x-16 md:pb-[140px]">
                ...
                <p className="text-main-event-3 text-center text-4xl font-bold md:text-5xl lg:text-6xl">Cabang Lomba</p>
                <div className="h-1 bg-white w-24 md:w-[200px] lg:w-[350px] hidden md:block"></div>
              </div>
