    ...
    <>
      <section className="bg-[url('/UnderMaintenance.png')] w-screen h-screen bg-cover bg-center">
        <div className="pt-20 lg:p-16 xl:p-32 flex flex-col items-center lg:items-start justify-center">
          <h1 className="text-2xl lg:text-5xl font-bold text-white font-secondary">We'll be back soon !</h1>
          <h2 className="lg:text-2xl font-normal text-white pt-4 w-4/5 text-justify lg:w-1/2 font-secondary">We’re sorry to say that this page currently under maintenance to improve your experience. Don’t worry we will go back as soon as possible.</h2>
          <a target="_blank" href="/">
            <button className="bg-white px-12 py-3 mt-16 lg:mt-16 font-secondary font-bold rounded-full hover:bg-[#27378E] hover:text-white ease-out duration-150 hover:ease-in hover:duration-150 hover:scale-105">Return to home</button>
          </a>
