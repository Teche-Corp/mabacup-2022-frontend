  ...
  return (
    ...
    <Toaster
      ...
      <div className="h-screen w-screen bg-[#E1EFF2] flex flex-col">
        ...
        <div className={`${page === 1 ? 'block' : 'hidden'} w-10/12 lg:w-1/2 h-1/2 mx-auto my-auto bg-white rounded-xl overflow-hidden`}>
          <div className="bg-[#C5D8EB] h-1/3 w-full ">
            <div className="flex items-center h-full pl-6">
              <h1 className="text-[#5189C4] font-secondary font-bold text-xl">Selamat datang, silakan cari NRP kamu disini !</h1>
            </div>
          </div>
        ...
        <div className={`${page === 2 ? 'block' : 'hidden'} w-3/4 h-3/5 mx-auto my-auto bg-white rounded-xl overflow-hidden`}>
          <div className="bg-[#C0DBCE] h-20 px-6 py-6">
            <h1 className="text-[#43936C] font-secondary text-2xl font-semibold ">Selamat! Kamu terpilih untuk menjadi staff Maba Cup 2022</h1>
            {/* <p>nama : {data?.nama}</p>
            <p>nrp : {data?.nrp}</p>
            <p>departemen : {data?.departemen}</p>
            <p>divisi : {data?.divisi_diterima}</p> */}
          </div>
          <div className=" h-full p-10">
            <h1 className="font-secondary text-3xl font-semibold">{data.nama}</h1>
            <div>
              <table className="table-auto border-spacing-4 p-4 mt-4">
              <tr>
                <td className="text-neutral-500">NRP</td>
                <td className="text-neutral-500">: <span className="text-black font-semibold">{data.nrp}</span></td>
              </tr>
              <tr>
                <td className="text-neutral-500">Asal Departemen &nbsp; &nbsp;</td>
                <td className="text-neutral-500">: <span className="text-black font-semibold">{data.departemen}</span></td>
              </tr>
              <tr>
                <td className="text-neutral-500">Divisi / Subdivisi</td>
                <td className="capitalize text-neutral-500">: <span className="text-black font-semibold">{data.divisi_diterima}</span></td>
              </tr>
              </table>
            ...
            href={"https://mabacup-its.com/KontakKadivKasubdiv"}><span className="cursor-pointer underline text-[#276CB6]">https://mabacup-its.com/KontakKadivKasubdiv</span></Link></p>
          </div>
        </div>

        {/* Ditolak */}
        <div className={`${page === 3 ? 'block' : 'hidden'} w-3/4 h-3/5 mx-auto my-auto bg-white rounded-xl overflow-hidden`}>
          <div className="bg-[#FFCECB] h-20 px-6 py-6">
            <h1 className="text-[#CB3A31] font-secondary text-2xl font-semibold ">Tetap semangat dan jangan putus asa yaa!</h1>
          ...
          <div className=" h-full p-10">
            ...
            <div>
              ...
              <tr>
                ...
                <td className="text-neutral-400">: <span className="text-black font-semibold">{data.nrp}</span></td>
              </tr>
              <tr>
                <td className="text-neutral-400">Asal Departemen &nbsp; &nbsp;</td>
                <td className="text-neutral-400">: <span className="text-black font-semibold">{data.departemen}</span></td>
              </tr>
              <tr>
                <td className="text-neutral-400">Divisi / Subdivisi</td>
                <td className="capitalize text-neutral-400">: <span className="text-black font-semibold">{data.divisi_diterima}</span></td>
              </tr>
              </table>
